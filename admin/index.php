...
<head>
  ...
  <title>App TI | Hafizh Fadhlurrohman</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Hafizh Fadhlurrohman</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="index.php?p=kategori" class="nav-link <?= ($p == 'kategori') ? 'active' : '' ?>">
              <i class="nav-icon fas fa-regular fa-server"></i>
              <p>
                Kategori
              </p>
            </a>
          ...
          <li class="nav-header mt-4 border-top">
              <i class=""></i>
              <p>ADMIN PAGE</p>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="index.php?p=level" class="nav-link <?= ($p == 'level') ? 'active' : '' ?>">
              <i class="nav-icon fas fa-light fa-layer-group"></i>
              <p>
                Level
              </p>
            </a>
